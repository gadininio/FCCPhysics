...
inputDir       = f'../../../outputs/higgs/zh_hww_4l/mva{"_loose" if is_loose else ""}/ecm{ecm}/final_selection/{"full" if is_full else ""}/'
selection      = "sel0"

intLumi        = 1.0 # assume histograms are scaled in previous step
outputDir      = f'../../../outputs/higgs/zh_hww_4l/mva{"_loose" if is_loose else ""}/ecm{ecm}/combine/{"full" if is_full else ""}/{selection}'
mc_stats       = True
rebin          = 10
