...
inputDir = f'../../../outputs/higgs/zh_hww_4l/mva{"_loose" if is_loose else ""}/ecm{ecm}/preselection_with_bdt/full/'

# Input directory where the files produced at the pre-selection level are
# Optional: output directory, default is local running directory
outputDir = f'../../../outputs/higgs/zh_hww_4l/mva{"_loose" if is_loose else ""}/ecm{ecm}/final_selection/full/'
