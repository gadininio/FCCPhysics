...
inputDir = f"outputs/ntuples/{flavor}/"
...
def build_graph(df, dataset):
    ...
    results.append(df.Histo1D(("ww_leptonic", "", *bins_bool), "ww_leptonic"))
    ...
    # # ### CUT 7: leptonic WW
    # # #########
    # # if "wzp6_ee_eeH_HWW_ecm240" in dataset or "wzp6_ee_mumuH_HWW_ecm240" in dataset: # remove muons/electrons from inclusive WW
